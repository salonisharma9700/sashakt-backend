...
const JumbleWord = require('../models/jumbleModel')
...
router.get('/getuser', async (req, res) => {
  ...
  try {
    ...
    else
    {
      ...
      const Jumbleword = await  JumbleWord.findOne({user : userId})
      const Wordsearch =await WordSearch.findOne({user : userId})
      res.json({user_data, puzzle,wagascore,Jumbleword, Wordsearch,  auth : true });
    }
